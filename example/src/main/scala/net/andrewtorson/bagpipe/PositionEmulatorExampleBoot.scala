...
import net.andrewtorson.bagpipe.networking.ExampleTcpClientModuleProto
import net.andrewtorson.bagpipe.streaming.PositionEmulatorExampleStreamingModule
import net.andrewtorson.bagpipe.utils._



object PositionEmulatorExampleBoot extends App with LazyLogging{
  ...
  private def launchServices = {
    ...
    new PositionEmulatorExampleStreamingModule(new ServiceBusModuleImpl(modules))
    new ExampleTcpClientModuleProto(modules)
